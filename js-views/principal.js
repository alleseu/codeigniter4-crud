...
const URL_BASE = 'http://localhost/codeigniter4-crud/';
const EXITO = 1;
...
//FUNCIÓN QUE FORMATEA UN OBJETO CON MENSAJES DE ERRORES DE ENTRADA EN UN SOLO STRING.
function formatearMensaje(objeto) {

	//Comprueba si hay más de un mensaje, para así definir cómo formatearlo.
	if(Object.values(objeto).length > 1) {
		...
		let mensaje = Object.values(objeto)[0];
	}

	return mensaje;  //Retorna el string con mensajes de errores de entrada.
}
