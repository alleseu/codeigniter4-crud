...
<head>
	...
	<!-- Bootstrap core CSS -->
	<link href="<?php echo base_url('resources/libraries/bootstrap-4.5.0/dist/css/bootstrap.min.css'); ?>" rel="stylesheet" type="text/css">

	<!-- Fonts - Font Awesome core CSS -->
	<link href="<?php echo base_url('resources/libraries/fontawesome-free-5.13.1-web/css/all.min.css'); ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo base_url('resources/libraries/fonts/loadfonts.css'); ?>" rel="stylesheet" type="text/css">

	<!-- Estilos personalizados para las plantillas -->
	<link href="<?php echo base_url('resources/libraries/bootstrap-4.5.0/custom/bootstrap.css'); ?>" rel="stylesheet" type="text/css">

	<!-- Jquery-confirm core CSS -->
	<link href="<?php echo base_url('resources/libraries/jquery-confirm-3.3.4/dist/jquery-confirm.min.css'); ?>" rel="stylesheet" type="text/css">

	<!-- DataTables core CSS -->
	<link href="<?php echo base_url('resources/libraries/datatables/datatables.min.css'); ?>" rel="stylesheet" type="text/css">


	<!-- SCRIPTS: -->

	<!-- jQuery library -->
	<script src="<?php echo base_url('resources/libraries/jquery-3.5.1/jquery.min.js'); ?>" type="text/javascript"></script>
	<script src="<?php echo base_url('resources/libraries/popper-1.16.1/umd/popper.min.js'); ?>" type="text/javascript"></script>

	<!-- Bootstrap core JavaScript -->
	<script src="<?php echo base_url('resources/libraries/bootstrap-4.5.0/dist/js/bootstrap.min.js'); ?>" type="text/javascript"></script>

	<!-- Jquery-confirm core JavaScript -->
	<script src="<?php echo base_url('resources/libraries/jquery-confirm-3.3.4/dist/jquery-confirm.min.js'); ?>" type="text/javascript"></script>

	<!-- DataTables core JavaScript -->
	<script src="<?php echo base_url('resources/libraries/datatables/datatables.min.js'); ?>" type="text/javascript"></script>

	<!-- Scripts con la lógica de la vista -->
	<script src="<?php echo base_url('js-views/principal.js'); ?>" type="text/javascript"></script>
	<script src="<?php echo base_url('js-views/mantenedor.js'); ?>" type="text/javascript"></script>
</head>
...
<body>
	...
	<footer class="bg-person">
		<div class="container">
			<span>Copyright &copy; 2020 - Todos los derechos reservados.</span>
		</div>
	</footer>
